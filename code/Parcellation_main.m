...
%         ind_parcel_r=find_center(similarity_r,atlas.r_parcel);        
        ...
        labels_l=region_growing_ly_r1(ind_parcel_l, similarity_l,neibors,medialwall_l==0,[],leftnum);
        labels_r=region_growing_ly_r1(ind_parcel_r, similarity_r, neibors,medialwall_r==0,[],rightnum);
